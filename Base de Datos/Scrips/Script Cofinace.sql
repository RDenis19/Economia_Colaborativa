...
CREATE TABLE IF NOT EXISTS `cofinance`.`Proyectos` (
  ...
  `tipoRetorno` ENUM('Recompensa', 'Donación', 'Prestamo', 'Inversión') NULL,
  ...
  PRIMARY KEY (`idProyectos`, `Categoria_idCategoria`, `TiposCrowfunding_idTiposCrowfunding`),
...
CREATE TABLE IF NOT EXISTS `cofinance`.`Validacion` (
  ...
  `nombreValidacion` VARCHAR(45) NOT NULL,
